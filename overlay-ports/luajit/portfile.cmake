vcpkg_from_github(
    ...
    REPO LuaJIT/LuaJIT
    REF 3c4f9fe2052b8d08a917ac0d5f38563f0297b5a3  # 2026-07-11
    SHA512 21c063405bda460f736b310d7996965150ccf0d965fd130c873be31bd23edbf6c16a58bcd037b09ef3a3cf450f9b56f8ecf9158c99857a4568061b6f4df5f909
    HEAD_REF master
    PATCHES
        msvcbuild.patch
...
if(VCPKG_DETECTED_MSVC)
    ...
    vcpkg_list(SET options)
    set(target_sys "")
    list(APPEND options "EXECUTABLE_SUFFIX=${VCPKG_TARGET_EXECUTABLE_SUFFIX}")
    if(VCPKG_CROSSCOMPILING)
        list(APPEND options "LJARCH=${VCPKG_TARGET_ARCHITECTURE}")
        if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_DETECTED_MSVC)
            list(APPEND options
                "HOST_CC=cc"
    ...
    if(NOT target_sys STREQUAL "")
        list(APPEND options "TARGET_SYS=${target_sys}")
    endif()
    list(APPEND options
